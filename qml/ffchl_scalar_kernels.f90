subroutine fget_local_kernels_fchl(x1, x2, n1, n2, nneigh1, nneigh2, &
...
end subroutine fget_local_kernels_fchl


subroutine fget_local_symmetric_kernels_fchl(x1, n1, nneigh1, sigmas, nm1, nsigmas, &
       & t_width, d_width, cut_start, cut_distance, order, pd, &
       & distance_scale, angular_scale, alchemy, two_body_power, three_body_power, kernels)
...
end subroutine fget_local_symmetric_kernels_fchl
...
subroutine fget_local_atomic_kernels_fchl(x1, x2, n1, n2, nneigh1, nneigh2, &
       & sigmas, nm1, nm2, na1, nsigmas, &
       & t_width, d_width, cut_start, cut_distance, order, pd, &
       & distance_scale, angular_scale, alchemy, two_body_power, three_body_power, kernels)
    ...
    !$OMP PARALLEL DO schedule(dynamic) PRIVATE(ni,nj,idx1,l2dist)
    do a = 1, nm1
        ni = n1(a)
        do i = 1, ni
            ...
            do b = 1, nm2
                ...
                do j = 1, nj
                    ...
                    do k = 1, nsigmas
                       ...
                       kernels(k, idx1, b) = kernels(k, idx1, b) &
...
end subroutine fget_local_atomic_kernels_fchl
